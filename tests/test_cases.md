Test Case 1: Valid Customer Profile - Low Risk & High Value Customer

Input ->
Customer name is: Akarshit
Age of the customer is: 28
City of the customer: Chandigarh
Monthly income of the customer: 100000
Monthly expenses of the customer: 20000
The existing EMI amount: 10000
The credit score of the customer: 800
The segment of the customer:(STANDARD / PREMIUM / ENTERPRISE): Premium

Output ->
Monthly savings are: 80000
Savings percentage are: 80.0
EMI-to-income ratio: 0.1
Risk Category: LOW Risk
Customer Value Category: High Value
Test Cases

Test Case 2: Valid Customer Profile - Low Risk & Medium Value Customer 
...
Test Case 3: Valid Customer Profile - Medium Risk & High Value Customer
...
Test Case 4: Product Billing With Delivery Charge Waived
...
Test Case 5: Product Billing With Delivery Charge Applied
...
Test Case 6: Loan Eligibility Approved
...
Test Case 7: Loan Eligibility Rejected Due to Credit Score
...
Test Case 8: Loan Eligibility Manual Review Required
...
Test Case 9: Campaign Eligibility - Premium Upsell Campaign
...
Test Case 10: Campaign Eligibility - Cashback Campaign
...
Test Case 11: Invalid Input - Negative Age
...
Test Case 12: Invalid Input - Credit Score Outside Range
...
Test Case 13: Invalid Input - Product Quantity Less Than 1
...
Test Case 14: Invalid Input - Discount Percentage Above 100
...
Test Case 15: Invalid Input - Invalid Customer Segment
